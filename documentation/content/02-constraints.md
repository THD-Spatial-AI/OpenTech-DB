...
|----|------------|----------|
| TC-01 | Implementation language: **Python 3.11+** | Team expertise; ecosystem for data and energy modelling. |
| TC-02 | Web framework: **FastAPI** | Async-capable, automatic OpenAPI docs, Pydantic integration. |
...
| OC-04 | Development environment: **Windows + conda (Anaconda)** | Institutional IT setup. |
| OC-05 | No cloud infrastructure budget at initial stage | Local uvicorn deployment only. |