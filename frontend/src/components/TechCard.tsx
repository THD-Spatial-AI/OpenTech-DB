...
const TECH_IMAGES: Record<string, string> = {
  ...
  // ── Conversion ──────────────────────────────────────────────────────────
  alkaline_electrolyzer_awe:   "/img/alkaline_electrolyser.jpg",
  pem_electrolyzer:            "/img/pem_electrolyser.jpg",
  soec_electrolyzer:           "/img/solid_oxide_electrolyser.jpg",
  pem_fuel_cell:               "/img/pem_fuel_cell.jpg",
  sofc_fuel_cell:              "/img/solid_oxide_fuel_cell.jpg",
  air_source_heat_pump:        "/img/air_source_heat_pump.jpg",
  ground_source_heat_pump:     "/img/ground_source_heat_pump.jpg",
  electric_boilers:            "/img/electric_boiler.jpg",
  chp_gas:                     "/img/combined_heat_power.jpg",
  biomass_chp:                 "/img/biomass_chp.jpg",
